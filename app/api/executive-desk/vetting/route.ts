...
export async function GET(request: NextRequest) {
  try {
    ...
    // Build where clause for executive vetting (claims that have completed audit)
    const where: any = {
      status: {
        in: ['AUDIT_COMPLETED', 'APPROVED', 'REJECTED']
      }
    }
    ...
    console.error("Error fetching executive desk vetting claims:", error)
    return NextResponse.json(
