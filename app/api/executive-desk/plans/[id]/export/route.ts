...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      console.error("Executive Desk export build fallback triggered:", {
        planId: plan.id,
    ...
    return new NextResponse(buffer, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="executive-desk-custom-plan-${plan.plan_id ?? plan.id}-${dateTag}.xlsx"`,
      },
    })
  } catch (error) {
    console.error("Error exporting Executive Desk custom plan:", error)
