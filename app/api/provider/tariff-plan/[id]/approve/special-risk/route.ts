...
export async function POST(
  ...
  try {
    ...
    const hasPermission = await checkPermission(session.user.role as any, "provider", "approve_tariff_plan")
    ...
    await prisma.auditLog.create({
      data: {
        ...
        action: "TARIFF_PLAN_STAGE_SPECIAL_RISK_APPROVED",
