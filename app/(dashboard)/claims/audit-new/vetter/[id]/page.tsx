...
export default function AuditPage() {
  ...
  const rejectMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("Claim rejected and returned to Vetter 2")
      clearDraft()
      navigateBack()
      queryClient.invalidateQueries({ queryKey: ["claim-details"] })
      queryClient.invalidateQueries({ queryKey: ["claims"] })
  ...
  if (claim.current_stage !== 'audit' && claim.current_stage !== 'vetter2' && claim.current_stage !== 'vetter1') completedStages.push('audit')
      ...
      <div className="space-y-6 pb-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <Badge className="bg-amber-600 hover:bg-amber-700">AUDIT STAGE</Badge>
                <div className="h-1.5 w-1.5 rounded-full bg-gray-300" />
                <p className="text-xs text-gray-400 font-bold tracking-widest uppercase">Internal Audit & Compliance</p>
              </div>
              <h1 className="text-3xl font-black text-gray-900 tracking-tight">Audit Claim: {claim.claim_number}</h1>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="border-amber-200 shadow-sm overflow-hidden">
            <CardHeader className="py-3 bg-amber-50/60 border-b">
            ...
            <CardContent className="pt-4">
              <div className="rounded-xl border border-amber-100 bg-amber-50/40 p-4 text-sm font-semibold text-gray-800 whitespace-pre-wrap">
                {clinicalDiagnosis}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-slate-200 shadow-sm overflow-hidden">
            ...
            <CardContent className="pt-4">
              <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 text-sm font-semibold text-gray-800 whitespace-pre-wrap">
                {clinicalFindings}
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="border-gray-200 shadow-sm overflow-hidden">
          ...
          <CardContent className="pt-4">
            <Textarea
              placeholder="Add your audit compliance remarks or findings..."
        ...
        {/* Action Section */}
        <Card className="border-2 border-amber-600 bg-amber-600 text-white shadow-xl">
          <CardContent className="py-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-1">
                <h4 className="font-black text-xl">Confirm Audit Verdict</h4>
                <p className="text-amber-100 text-sm font-medium">Claims approved here are queued for final Management/MD approval</p>
              </div>
        ...
        <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader className="gap-2">
              ...
              <DialogTitle className="text-xl font-bold">Reject at Audit?</DialogTitle>
              <DialogDescription>
                This will send the claim back to Vetter 2 for review.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
          ...
          <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto p-0 border-none shadow-2xl">
            <div className="sticky top-0 z-10 bg-white border-b p-6">
              <DialogHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <Badge variant="outline" className="mb-2 border-amber-200 text-amber-700 bg-amber-50 font-bold">AUDIT HISTORY</Badge>
            ...
            <div className="p-8 space-y-8 bg-gray-50/30">
              ...
              <div className="bg-white rounded-2xl p-6 border shadow-sm">
                ...
                <div className="text-lg font-bold text-gray-800 bg-amber-50/30 p-4 rounded-xl border border-amber-100">
            ...
            <div className="p-6 bg-white border-t flex justify-end">
              <Button onClick={() => setShowEncountersModal(false)} className="rounded-full px-8 font-bold bg-amber-600 hover:bg-amber-700 text-white border-none shadow-lg">CLOSE VIEW</Button>
            </div>
          </DialogContent>
        </Dialog>
