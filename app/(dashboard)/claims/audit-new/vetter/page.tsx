...
export default function VetterPage() {
  ...
  const vetAllMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["audit-claims"] })
  ...
  const handleVetClaim = (claim: Claim) => {
    ...
    router.push(`/claims/audit-new/vetter/${claim.id}?returnTo=${encodeURIComponent(returnTo)}`)
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Operations Desk - Quality assurance review</p>
          </div>
          <PermissionGate module="claims" action="vet">
            <Button 
