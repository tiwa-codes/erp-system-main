...
export default function ClaimDetailsPage({ params }: { params: { id: string } }) {
  ...
  // Mock claim services data (replace with real API call)
  const claimServices: ClaimService[] = [
    {
      id: "1",
      service_name: "Lab",
      amount: 4000,
      status: "PENDING",
      approval_code: "APR/2025/07/23"
    },
    {
      id: "2", 
      ...
      amount: 10000,
      status: "REJECTED",
      approval_code: "APR/2025/07/29"
    },
    {
      id: "3",
      service_name: "Ultra Sound Scan", 
      amount: 3500,
      status: "FLAGGED",
      approval_code: "APR/2025/07/30"
    },
    {
      id: "4",
      service_name: "Lab",
