...
export default function VetterPage() {
  ...
  const { data: claimsData, isLoading } = useQuery({
    queryKey: ["vetter1-claims", currentPage, limit, debouncedSearchTerm, selectedStatus, selectedProvider],
    queryFn: async () => {
  ...
  const handleVetClaim = (claim: Claim) => {
    ...
    router.push(`/claims/vetter1/vetter/${claim.id}?returnTo=${encodeURIComponent(returnTo)}`)
  }
    ...
    <PermissionGate module="claims" action="vet">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Vetter 1</h1>
            <p className="text-gray-600">First-level claim review and validation</p>
          </div>
