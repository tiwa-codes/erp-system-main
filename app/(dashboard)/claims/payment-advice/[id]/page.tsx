...
export default function ClaimsPaymentAdviceDetailPage() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["claims-payment-advice-detail", providerId],
        queryFn: async () => {
    ...
    const handleDownloadPdf = async () => {
        ...
        try {
            ...
            pdf.save(
                `Payment_Advice_${provider?.facility_name || "Provider"}_${
        ...
        <PermissionGate module="claims" action="view">
            <div className="space-y-8 pb-20 max-w-[1400px] mx-auto">
                ...
                <div className="flex items-center justify-between no-print">
                    <Button
                        variant="outline"
                        onClick={() => router.push("/claims/payment-advice")}
                    ...
                    <div className="flex items-center gap-3">
                        <Button
                            ...
                            className="rounded-full font-bold gap-2 border-gray-200"
                        >
                ...
                <div className="grid grid-cols-1 gap-8">
                        ...
                        <div ref={pdfRef} className="bg-white p-8 sm:p-12 text-gray-900 min-w-[1200px]">
                            ...
                            <div className="flex justify-between items-start mb-12">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <div className="bg-emerald-600 h-16 w-16 rounded-xl flex items-center justify-center text-white font-black text-2xl rotate-3 shadow-lg">
                                            CJH
                                        </div>
                            ...
                            <div className="mb-8">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <Badge className="bg-emerald-600 text-white border-none font-black text-[10px] uppercase px-4 py-1.5 rounded-full shadow-lg shadow-emerald-100">
                                        Reference: PAV-{new Date().getFullYear()}-
                                ...
                                <div className="border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                                    <Table className="w-full">
                                        <TableHeader className="bg-gray-50/80 border-b">
                                            <TableRow>
                                                <TableHead className="w-12 font-black text-[9px] text-gray-400 uppercase tracking-widest pl-4 py-4">
                                                    S/N
                                                </TableHead>
                                                ...
                                                <TableHead className="font-black text-[9px] text-gray-400 uppercase tracking-widest">Approval Code</TableHead>
                                                ...
                                                <TableHead className="font-black text-[9px] text-gray-400 uppercase tracking-widest pr-4">
                                                    Payment Date
                                                </TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                            {claims?.map((claim, index) => (
                                                ...
                                                >
                                                    <TableCell className="pl-4 font-bold text-gray-400 text-[10px]">
                                                        {(index + 1).toString().padStart(2, "0")}
                                                    </TableCell>
                                                    <TableCell className="font-bold text-gray-700 text-[10px]">
                                                    ...
                                                    <TableCell className="font-bold text-gray-900 text-[11px] whitespace-nowrap">
                                                        ...
                                                        <span className="text-[9px] text-gray-400 font-bold uppercase tracking-tighter">
                                                            {claim.enrollee_id} &bull; {claim.enrollee_type}
                                                        </span>
                                                    </TableCell>
                                                    <TableCell className="font-mono text-[10px] text-emerald-600 font-black">
                                                        {claim.approval_code}
                                                    </TableCell>
                                                    <TableCell className="bg-emerald-50/30 font-bold text-[10px] text-gray-700">
                                                        ...
                                                        | <span className="text-red-500">₦{claim.total_diff.toLocaleString()}</span>
                                                    </TableCell>
                                                    <TableCell
                                                        className="text-[10px] text-gray-600 max-w-[150px] truncate"
                                                        title={claim.drugs}
                                                    >
                                                        {claim.drugs}
                                                    </TableCell>
                                                    <TableCell
                                                        className="text-[9px] text-gray-400 italic max-w-[120px] truncate"
                                                        title={claim.drug_comments}
                                                    >
                                                        {claim.drug_comments}
                                                    </TableCell>
                                                    <TableCell
                                                    ...
                                                    <TableCell
                                                        className="text-[9px] text-gray-400 italic max-w-[120px] truncate"
                                                        title={claim.service_comments}
                                                    >
                                                        {claim.service_comments}
                                                    </TableCell>
                                                    <TableCell className="pr-4 font-black text-gray-900 text-[10px]">
                                                        {new Date(claim.payment_date).toLocaleDateString("en-GB")}
                                                    </TableCell>
                                                </TableRow>
                                            ))}
                                        </TableBody>
                            ...
                            <div className="flex justify-between items-end mt-16 pt-12 border-t border-dashed border-gray-200">
                                ...
                                <div className="text-right max-w-sm">
                                    ...
                                    <p className="text-[10px] font-medium text-gray-400 leading-relaxed italic">
                                        This advice is generated based on vetted claims data. Payments are processed via
                                        electronic bank transfer. Please report any discrepancies within 48 hours.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mt-2 bg-blue-50 border border-blue-100 rounded-2xl p-6 flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-blue-800 font-medium leading-relaxed">
                                Download this advice as a high-fidelity landscape PDF using the button above. It includes
                                the provider details, full vetting breakdown, drugs, services, and total amount in words.
                            </p>
                        </div>
                    </div>
                </div>
