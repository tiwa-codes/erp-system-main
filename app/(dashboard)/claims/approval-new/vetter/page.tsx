...
export default function VetterPage() {
  ...
  const vetAllMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["approval-claims"] })
  ...
  const handleVetClaim = (claim: Claim) => {
    ...
    router.push(`/claims/approval-new/vetter/${claim.id}?returnTo=${encodeURIComponent(returnTo)}`)
  }
    ...
    <PermissionGate module="claims" action="vet">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">MD Approval</h1>
            <p className="text-gray-600">Executive Desk - Final approval decision</p>
          </div>
          <PermissionGate module="claims" action="vet">
            <Button 
