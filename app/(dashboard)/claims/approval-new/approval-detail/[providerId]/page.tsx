...
export default function ApprovalProviderPage() {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              Approval Overview &gt;&gt; {provider?.facility_name || 'Loading...'}
            </h1>
            <p className="text-gray-600">View and approve claims for this provider</p>
          </div>
        </div>
