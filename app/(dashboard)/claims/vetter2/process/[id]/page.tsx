...
export default function Vetter2ProcessPage() {
  ...
  const submitVettingMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      if (claim?.provider_id) {
        router.push(`/claims/vetter2/${claim.provider_id}`)
      } else {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/claims/vetter2")}>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Vetter 2 - Claims Processing</h1>
            ...
            <div className="flex items-center gap-4">
              <Select value={vettingOutcome} onValueChange={setVettingOutcome}>
                <SelectTrigger className="w-[300px]">
                  <SelectValue placeholder="--Select Vetter 2 Outcome--" />
                </SelectTrigger>
                <SelectContent>
              ...
              >
                {submitVettingMutation.isPending ? "Submitting..." : "Submit Vetter 2 Decision"}
              </Button>
            </div>
          </CardContent>
        </Card>
