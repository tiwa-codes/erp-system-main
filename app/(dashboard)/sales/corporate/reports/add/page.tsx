...
export default function AddCorporateSalesReportPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      router.push("/sales/corporate/reports")
    },
    onError: (error: Error) => {
      toast({
        title: "Error",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Add Public Sector Channel Report</h1>
          <p className="text-muted-foreground">Create a new sales report for public sector channel</p>
        </div>
      </div>
