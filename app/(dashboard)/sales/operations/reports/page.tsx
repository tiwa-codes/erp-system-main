...
export default function SalesOperationsReportsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["sales-operations-reports", page, search, typeFilter, statusFilter],
    queryFn: async () => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage and track all procurement reports</p>
        </div>
        <PermissionGate permission="sales:add">
          <Link href="/sales/operations/reports/add">
            <Button>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>All procurement reports</CardDescription>
            </div>
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <PermissionGate permission="sales:view">
                              <DropdownMenuItem
                                onClick={() => router.push(`/sales/operations/reports/${report.id}`)}
                              >
                            ...
                            {(report.status === SalesReportStatus.DRAFT ||
                              ...
                              <PermissionGate permission="sales:edit">
                                <DropdownMenuItem
                                  onClick={() =>
                                    router.push(`/sales/operations/reports/${report.id}/edit`)
                                  }
                                >
