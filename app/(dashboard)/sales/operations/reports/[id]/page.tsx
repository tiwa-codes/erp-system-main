...
export default function SalesOperationsReportDetailPage({ params }: { params: { id: string } }) {
  ...
  const submitMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["sales-operations-report", params.id] })
    },
    onError: (error: Error) => {
      toast({
        title: "Error",
