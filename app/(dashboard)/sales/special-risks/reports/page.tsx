...
export default function SpecialRisksSalesReportsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["special-risks-sales-reports", page, search, typeFilter, statusFilter],
    queryFn: async () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Special Service Sale Reports</h1>
          <p className="text-muted-foreground">Manage and track all special service sale reports</p>
        </div>
        <PermissionGate permission="sales:add">
          <Link href="/sales/special-risks/reports/add">
            <Button>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>All special service sale reports</CardDescription>
            </div>
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <PermissionGate permission="sales:view">
                              <DropdownMenuItem
                                onClick={() => router.push(`/sales/special-risks/reports/${report.id}`)}
                              >
                            ...
                            {(report.status === SalesReportStatus.DRAFT ||
                              ...
                              <PermissionGate permission="sales:edit">
                                <DropdownMenuItem
                                  onClick={() =>
                                    router.push(`/sales/special-risks/reports/${report.id}/edit`)
                                  }
                                >
