...
export default function AddAgencySalesReportPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      router.push("/sales/agency/reports")
    },
    onError: (error: Error) => {
      toast({
        title: "Error",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Add Institutional Business & Digital Sales Report</h1>
          <p className="text-muted-foreground">Create a new sales report for institutional business & digital sales</p>
        </div>
      </div>
