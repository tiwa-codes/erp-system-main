...
export default function AgencySalesReportsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["agency-sales-reports", page, search, typeFilter, statusFilter],
    queryFn: async () => {
      const params = new URLSearchParams({
        page: page.toString(),
        limit: "20",
        submodule: SalesSubmodule.AGENCY_SALES,
        ...(search && { search }),
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Institutional Business & Digital Sales Reports</h1>
          <p className="text-muted-foreground">Manage and track all institutional business & digital sales reports</p>
        </div>
        <PermissionGate permission="sales:add">
          <Link href="/sales/agency/reports/add">
            <Button>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>All institutional business & digital sales reports</CardDescription>
            </div>
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <PermissionGate permission="sales:view">
                              <DropdownMenuItem
                                onClick={() => router.push(`/sales/agency/reports/${report.id}`)}
                              >
                            ...
                            {(report.status === SalesReportStatus.DRAFT ||
                              ...
                              <PermissionGate permission="sales:edit">
                                <DropdownMenuItem
                                  onClick={() =>
                                    router.push(`/sales/agency/reports/${report.id}/edit`)
                                  }
                                >
