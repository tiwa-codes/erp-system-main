...
/**
 * Legacy Internal Control Vetting Page - Redirects to new vetter pages
 * Redirects to /claims/vetter1/vetter/[id] or /claims/vetter2/vetter/[id]
 * based on the claim's current_stage
 */
export default function LegacyOperationDeskVettingRedirect() {
  ...
  const { data: claimData, isLoading } = useQuery({
    queryKey: ["claim-redirect-opdsk", claimId],
    queryFn: async () => {
