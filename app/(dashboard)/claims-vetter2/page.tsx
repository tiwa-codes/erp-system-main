  ...
  const getActionDropdown = (claim: Claim) => {
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          <DropdownMenuItem
            onClick={() => router.push(`/claims/vetter2/process/${claim.id}`)}
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>Vetter 2 - Claims Processing</CardTitle>
                <CardDescription className="mt-2">Process claims from Vetter 1</CardDescription>
              </div>
              ...
              <div className="px-6 py-4">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-green-600">₦{selectedClaim.amount?.toLocaleString() || '0'}</p>
                  </div>
