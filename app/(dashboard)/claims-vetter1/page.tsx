  ...
  const getActionDropdown = (claim: Claim) => {
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          <DropdownMenuItem 
            onClick={() => router.push(`/claims/vetter1/process/${claim.id}`)}
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>Vetter 1 - Claims Processing</CardTitle>
                <CardDescription className="mt-2">Process claims directly from providers</CardDescription>
              </div>
