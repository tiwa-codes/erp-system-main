                  ...
                  {selectedInvoice.attachment_url && (
                    <div className="col-span-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 mt-1 text-blue-600 hover:underline text-sm text-left"
                      >
                    ...
                    {[
                      {
                        ...
                        comment: selectedInvoice.dept_oversight_comment,
                        by: selectedInvoice.dept_oversight_by,
                        at: selectedInvoice.dept_oversight_at,
                      },
                      {
                        label: "Internal Control",
                        comment: selectedInvoice.operations_comment,
                        by: selectedInvoice.operations_by,
                        at: selectedInvoice.operations_at,
                      },
                      {
                        label: "Executive Desk",
                        comment: selectedInvoice.executive_comment,
                        by: selectedInvoice.executive_by,
                        at: selectedInvoice.executive_at,
                      },
                    ]
